                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {FEATURE_COMPARISON.map((category, categoryIndex) => (
                      <React.Fragment key={`category-frag-${categoryIndex}`}>
                        ...
                        {category.features.map((feature, featureIndex) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-center">
                              <FeatureValue value={(feature as any).free} />
                            </td>
                            <td className="px-4 py-3 text-center bg-tee-accent-primary/5">
                              <FeatureValue value={(feature as any).pro} highlight />
                            </td>
                            <td className="px-4 py-3 text-center">
                              <FeatureValue value={(feature as any).premium} />
                            </td>
                            <td className="px-4 py-3 text-center">
                              <FeatureValue value={(feature as any).enterprise} />
                            </td>
                          </tr>
                        ))}
                      </React.Fragment>
