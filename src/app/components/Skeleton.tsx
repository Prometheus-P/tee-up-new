...
// Fixed: Allow extra props like 'key' when used in maps by extending HTML attributes
interface SkeletonProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  'aria-label'?: string;
}

export function Skeleton({ className, 'aria-label': ariaLabel = '로딩 중', ...props }: SkeletonProps) {
  return (
    <div
      className={cn(
        'skeleton',
