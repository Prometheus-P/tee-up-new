...
export async function logSiteEvent(
  ...
  try {
    ...
    // Fixed: Correct type check for success property
...
export async function revealContactInfo(
  ...
  try {
    ...
    // Fixed: Explicit check for success to satisfy TS union narrowing
...
export async function revealContactByHandle(
  ...
  if (siteResult.success === false || !siteResult.data) {
