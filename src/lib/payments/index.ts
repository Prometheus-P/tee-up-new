...
// Using explicit path for types to avoid alias issues
import type { ISubscriptionPlan } from '@/types/index';
...
export async function handlePaymentSuccess(
  ...
  // Use btoa for basic auth to satisfy both browser and edge runtime
